...
// /gx35 and /support — edit lib/data/firmware.ts, not here.
const downloadTabs: FirmwareTab[] = downloadTabsFor("gx4k");
    ...
    return (
        <main className="overflow-x-clip bg-[#08080c]">
            ...
            <ScrollHero
                ...
                poster="/gx4k/hero_2-poster.webp"
            ...
            <section data-nav-theme="dark" className="pt-20 md:pt-28">
                <motion.div {...fadeUp} className={`${SHELL} mb-12 text-center md:mb-16`}>
                ...
                <section data-nav-theme="dark" className="py-16 md:py-24">
                    <div className={`${SHELL} text-center`}>
                        ...
                        <p className={`mx-auto mt-8 max-w-[620px] ${BODY} text-center`}>
                            The GX4K records straight out of the box, but full-time parking protection means hardwiring it properly into your fuse box. Our
                            certified installers fit it cleanly, hide every cable and set it up right the first time.
                        </p>
                        <Link
                            href="/installation"
                            ...
                            <div className="mt-10 grid grid-cols-2 gap-4 sm:gap-8 md:mt-12">
                                ...
                                <div className="flex h-full flex-col items-center text-center">
                                    ...
                                    <p className="mx-auto mt-3 max-w-[320px] text-[13px] leading-[1.6] text-[#a6a6a6] sm:text-[15px]">
                                        Crystal clear 4K recording for every drive. True 4K Ultra HD captures licence plates and street signs with SONY STARVIS
                                        clarity.
                                    </p>
                                ...
                                <div className="flex h-full flex-col items-center text-center">
                                    ...
                                    <p className="mx-auto mt-3 max-w-[320px] text-[13px] leading-[1.6] text-[#a6a6a6] sm:text-[15px]">
                                        Record every moment in 2K. Premium FineVu protection and features at a more accessible price point — the same trusted
                                        engineering.
                                    </p>
                                    <div className="flex flex-1 items-center justify-center py-6 md:py-8">
                                        {/* eslint-disable-next-line @next/next/no-img-element */}
