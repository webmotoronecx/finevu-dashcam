    ...
    >
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <select id="model" aria-required="true" aria-invalid={invalid.model || undefined} aria-describedby={invalid.model ? "model-err" : undefined} className={`${INPUT} appearance-none bg-[url('data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%2212%22%20height=%2212%22%20viewBox=%220%200%2024%2024%22%20fill=%22none%22%20stroke=%22%2355555C%22%20stroke-width=%222.5%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22%3E%3Cpolyline%20points=%226%209%2012%2015%2018%209%22/%3E%3C/svg%3E')] bg-[right_14px_center] bg-no-repeat pr-9`} value={form.model} onChange={(e) => set("model", e.target.value)}>
