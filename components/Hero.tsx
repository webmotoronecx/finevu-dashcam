            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href={slide.primary.href} className="w-full sm:w-auto">
                  <motion.button
                    className="cta-hover w-full sm:w-auto px-10 py-3.5 rounded-full bg-[var(--finevu-orange)] text-white font-semibold text-sm uppercase leading-[20px] smooth-transition"
                  >
                    {slide.primary.label}
                  </motion.button>
                </Link>
                <Link href="/retailers" className="w-full sm:w-auto">
                  <motion.button
                    className="cta-hover w-full sm:w-auto px-10 py-3.5 rounded-full border border-white/40 text-white font-semibold text-sm uppercase leading-[20px] hover:bg-white/10 transition-colors backdrop-blur-sm"
                  >
                    Find Retailer
                  </motion.button>
                </Link>
